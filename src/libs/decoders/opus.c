...
#ifdef _MSC_VER
#include <opus/opusfile.h> // Without pkg-config to provide the exact path to the Opus headers,
                           // our next-best location is relative to the primary include path.
#else
#include <opusfile.h>
#endif
